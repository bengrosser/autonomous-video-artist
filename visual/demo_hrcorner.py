#-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
 ...
 #Last Modified : Thu Jun  8 14:37:48 2017
 #Created By : Rui An  
...
def harris_visual(img):
    #TODO: Not quite sure about the size of the kernal
    ...
    def harris_measure(Sx2, Sy2, Sxy):
        ...
        harris_matrix = det_matrix - 0.04 * trace_square_matrix 
    ...
    for i in range(row):
        for j in range(column):
            if harris_result[i][j] > 0:
                element = harris_result[i][j]
                harris_result[i][j] = 255 - (element/harris_max)*255 
            else:
...
frame_rate = float(23.976024)
resolution = (int(1280), int(720))
