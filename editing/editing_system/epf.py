...
def editing_compare_frame_cluster(vid1_name, vid1_generator, key_1, vid2_name, vid2_generator, key_2, ff_memory):
    """
    ...
    for cluster_1_index in range(len(sampled_frames_cluster1)):
        ...
        for cluster_2_index in range(len(sampled_frames_cluster2)):
            ...
            similarity_vector = compare_gradient(down_scale_frame_1, down_scale_frame_2)
            # print "Spent ", time.time()-da_start_time, "seconds to finish gradient methods"
            # ellipse_time = time.time()
            corner_score = compare_ellipse(down_scale_frame_1, down_scale_frame_2)
            # print "Spent ", time.time()-ellipse_time, "seconds to finish ellipse methods"
            wave_score = compare_wave(down_scale_frame_1, down_scale_frame_2)
...
# Use this function in the editing process
def epf_with_generators(vid1_name, vid1_edit_source, vid2_name, vid2_edit_source, ff_memory):
    """
    ...
    for vid1_editing_pair in vid1_edit_source[0]:
        for vid2_editing_pair in vid2_edit_source[0]:
            ...
            ff_memory = editing_compare_frame_cluster(vid1_name, vid1_generator, vid1_editing_pair, vid2_name, vid2_generator,
                                                      vid2_editing_pair, ff_memory)
    return ff_memory
